...
##Script for determining the radial matrix element for two arbitrary states in Rubidium-85. 2x faster version.

RadialMatrixElementFaster <- function(k,n1,n2,l1,l2,j1,j2){
  #Constants and Settings
  #Number of Electrons
  Z <- 1
...
QuantumDefectAdjusted <- function(n,l,j){
...
RadialMatrixElementFasterAdjusted <- function(k,n1,n2,l1,l2,j1,j2){
  #Constants and Settings
  #Number of Electrons
  Z <- 1
  
  #Quantum numbers for states 1 and 2. Primary quantum number n, orbital angular momentum l, total angular momentum j
  delta1 <- QuantumDefectAdjusted(n1,l1,j1)
  delta2 <- QuantumDefectAdjusted(n2,l2,j2)
  E1 <- -1/(2*(n1-delta1)^2)
  E2 <- -1/(2*(n2-delta2)^2)
...
StarkMatrixElemAdjusted <- function(n1, n2, l1, l2, j1, j2, mj1, mj2){
  ...
  if(mj1 != mj2){
    ...
    if((l2==(l1+1))|(l2==(l1-1))){
      ...
      #Calculates the stark matrix element.
      StarkElem <- RadialMatrixElementFasterAdjusted(1,n1,n2,l1,l2,j1,j2)*(SumPlus + SumMinus)
