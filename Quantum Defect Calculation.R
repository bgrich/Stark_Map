##Script for determining the quantum defect of an arbitrary state

#Define the principal quantum number n, orbital angular momentum number l, and total angular momentum number j
